...
- **Auth:** **Auth.js** (NextAuth v5) with email/password for MVP — [ADR 0004](./0004-authentication.md).
...
- [ADR 0004](./0004-authentication.md) — authentication (credentials, JWT sessions).
